@component('mail::message', ['header_url' => '', 'header_title' => 'Magnetism Tech Ltd Limited.'])
    To
    {{ $masterbl->name }} <br>
    {{ $masterbl->mloaddress }}
    <br>
...
@slot('footer')
    @component('mail::footer')
        © {{ date('Y') }} Magnetism Tech Ltd Limited. All rights reserved.
    @endcomponent
@endslot
