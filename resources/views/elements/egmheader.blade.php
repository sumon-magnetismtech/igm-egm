...
<head>
    <title>@yield('title', 'Magnetism')</title>
    <!--[if lt IE 10]>
...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            <nav class="navbar header-navbar pcoded-header" style="background: linear-gradient(to right, #2DAA9E, #66D2CE);">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    <li>
                                        <a href="{{ route('change-password') }}"><i class="ti-settings"></i>
                                            Password</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('logout') }}"
