...
@section('breadcrumb-button')
    ...
    <a href="{{ route('feederinformations.create') }}" class="btn btn-out-dashed btn-sm btn-success"><i class="fa fa-plus"></i></a>
    @endcan
    ...
    <form action="" method="get">
        <div class="row">
            <div class="col-md-1 pr-md-1 my-1 my-md-0">
                <input type="text" id="igm" name="igm" class="form-control form-control-sm text-uppercase" placeholder="IGM" autocomplete="off" >
            </div>
            ...
            <div class="col-md-1 px-md-1 my-1 my-md-0">
                <input type="text" id="voyageNumber" name="voyageNumber" class="form-control form-control-sm text-uppercase" list="voyageList" placeholder="Voyage" autocomplete="off" >
            ...
            <div class="col-md-2 px-md-1 my-1 my-md-0">
                <input type="text" id="contref" name="contref" class="form-control form-control-sm" placeholder="Container">
            </div>
                ...
                @foreach($feederInformations as $key => $feederInfo)
                    <tr>
                        ...
                        <td>
                            <div class="icon-btn">
                                <nobr>
                                    <a href="{{route("feederinformations.show", $feederInfo->id)}}" data-toggle="tooltip" title="Details" class="btn btn-primary"><i class="fas fa-eye"></i></a>

                                    {{--@can('mloblinformation-create')--}}
                                    <a href="{{url("blEntryByFeeder/$feederInfo->id")}}" data-toggle="tooltip" class="btn btn-success addBlBtn" title="Add BL" target="_blank">
                                    ...
                                    <a href="{{ url('feederinformations/'.$feederInfo->id.'/edit') }}" data-toggle="tooltip" title="Edit" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                                    @endcan

                                    @can('mlo-feederinformation-delete')
                                    <form action="{{ url('feederinformations', [$feederInfo->id]) }}" method="POST" data-toggle="tooltip" title="Delete" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{ url('feeders/log/'.$feederInfo->id) }}" data-toggle="tooltip" title="Log" class="btn btn-dark"><i class="fas fa-history"></i></a>
                                    <button class="btn btn-outline-success moreButtonsSwitch" data-toggle="tooltip" title="More Options"><i class="fas fa-chevron-down"></i></button>
                                </nobr>
                            </div>
                            @if($feederInfo->mloblInformation->isNotEmpty())
                                <div class="d-none moreButtons">
                                    ...
                                    <div class="icon-btn">
                                        <a href="{{url("feederinformations/$feederInfo->id/ioccontainerlist")}}" target="_blank" data-toggle="tooltip" title="IOC" class="mt-1 btn btn-outline-dark"><i class="fas fa-paper-plane"></i> IOC</a>
                                        <a href="{{url("feederinformations/$feederInfo->id/lclContainerList")}}" data-toggle="tooltip" title="LCL Container List" class="mt-1 btn btn-outline-dark"><i class="fas fa-paper-print"></i> LCL</a>
                                        <a href="{{url("feederinformations/$feederInfo->id/inboundContainerList")}}" data-toggle="tooltip" title="Inbound Container List" class="mt-1 btn btn-outline-dark"><i class="fas fa-th"></i></a>
                                        <a href="{{url("feederinformations/$feederInfo->id/permissionPDF")}}" data-toggle="tooltip" title="Permission English" class="mt-1 btn btn-outline-dark"><i class="fas fa-envelope"></i></a>
                                        <a href="{{url("feederinformations/$feederInfo->id/permissionBengaliPDF")}}" data-toggle="tooltip" title="Permission Bengali" class="mt-1 btn btn-outline-dark"><i class="fas fa-envelope"></i></a>
                                        <a href="{{url("feederinformations/$feederInfo->id/arrivalNoticePDF")}}" target="_blank" data-toggle="tooltip" title="Arrival Notice" class="mt-1 btn btn-outline-dark"><i class="fas fa-copy"></i></a>
                                    </div>
                                </div>
                            @endif
                        </td>
