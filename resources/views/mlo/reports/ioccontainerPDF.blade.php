...
<head>
    ...
    <style>
        ...
        table, table th, table td {border-spacing: 0; font-size: 10px}
                ...
                @foreach($mloblInformation->blcontainers as $key => $container)
                    ...
                    <tr>
                        ...
                        @if($loop->first)
                            ...
                            <td rowspan="{{$totalContiner}}" class="textCenter"> {{$mloblInformation->bolreference}}</td>
                        @endif
                        <td> {{$container->contref}}</td>
                        <td class="textCenter"> {{$container->type}}</td>

                        @if($loop->first)
                            <td  rowspan="{{$totalContiner}}" class="textCenter"> {{$mloblInformation->pOrigin}}</td>
