...
@section('content')
    @if($formType == 'edit')
        <form action="{{ route('mlomoneyreceipts.update', $mlomoneyreceipt->id) }}" method="post" class="custom-form">
            @method('PUT')
            <input type="hidden"  name="id" value="{{$mlomoneyreceipt->id}}">
    @else
        <form action="{{ route('mlomoneyreceipts.store') }}" method="post" class="custom-form">
            @endif
            @csrf
            <div class="row px-2 d-flex align-items-end">
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" placeholder="dd/mm/yyyy" id="issueDate" aria-label="Departure" class="form-control" name="issueDate" value="{{ old("issueDate") ? old("issueDate") : (!empty($mlomoneyreceipt) ? date('d/m/Y', strtotime($mlomoneyreceipt->issueDate)) : date('d/m/Y', strtotime(now()))) }}" autocomplete="off" required>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> BL Reference <span class="text-danger">*</span></span>
                        <input type="text" id="bolRef" name="bolRef" class="form-control text-uppercase" value="{{old("bolRef") ? old("bolRef") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->bolRef : null) }}" onchange="getBLInfo()" required tabindex="-1" spellcheck="false" autocomplete="off" autofocus>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Vessel </span>
                        <input type="text" id="vessel" class="form-control" name="feederVessel" value="{{old('feederVessel') ? old('feederVessel') : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->molblInformations->mlofeederInformation->feederVessel : null)}}" readonly tabindex="-1">
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Voyage No </span>
                        <input type="text" id="voyage" name="voyageNumber" class="form-control" value="{{old('voyageNumber') ? old('voyageNumber') : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->molblInformations->mlofeederInformation->voyageNumber : null)}}" readonly tabindex="-1">
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Rotation No <span class="text-danger">*</span></span>
                        <input type="text" id="rotationNo" name="rotationNo" class="form-control" placeholder="Rotation No" value="{{old('rotationNo') ? old('rotationNo') : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->molblInformations->mlofeederInformation->rotationNo : null)}}" tabindex="-1">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Principal </span>
                        <input type="text" id="principal" name="principal" class="form-control" value="{{old('principal') ? old('principal') : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->molblInformations->principal->name : null)}}" readonly tabindex="-1">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <textarea id="doNote" name="note" style="color: red;" class="form-control bg-warning font-weight-bold text-danger" readonly tabindex="-1">{{old('note') ? old('note') : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->molblInformations->note : null)}}</textarea>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" min="0" id="freeTime"  name="freeTime" class="form-control" placeholder="Free Time" value="{{old("freeTime") ? old("freeTime") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->freeTime : 0)}}">
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fromDate" name="fromDate" class="form-control" value="{{ old("fromDate") ? old("fromDate") : (!empty($mlomoneyreceipt) ? date('d/m/Y', strtotime($mlomoneyreceipt->fromDate)) : null)}}" placeholder="dd/mm/yyyy" autocomplete="off" tabindex="-1" required readonly>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="tillDate" name="tillDate" class="form-control" value="{{ old("tillDate") ? old("tillDate") : (!empty($mlomoneyreceipt) && $mlomoneyreceipt->tillDate ? date('d/m/Y', strtotime($mlomoneyreceipt->tillDate)) : null)}}" placeholder="dd/mm/yyyy" autocomplete="off" tabindex="-1" required readonly>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="uptoDate" name="uptoDate" class="form-control" value="{{ old("uptoDate") ? old("uptoDate") : (!empty($mlomoneyreceipt) ? ($mlomoneyreceipt->uptoDate ? date('d/m/Y', strtotime($mlomoneyreceipt->uptoDate)) : null) : null) }}" placeholder="dd/mm/yyyy" autocomplete="off" required>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Total (Days)</span>
                        <input type="number" id="duration" name="duration" class="form-control" value="{{old("duration") ? old("duration") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->duration : 0) }}" min="0" readonly tabindex="-1">
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" id="chargeableDays"  name="chargeableDays" class="form-control" value="{{old("chargeableDays") ? old("chargeableDays") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->chargeableDays : 0) }}" min="0" tabindex="-1" readonly>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-9 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Client Name <span class="text-danger">*</span></span>
                        <input type="text" id="clientName" name="clientName" class="form-control text-uppercase" value="{{old("clientName") ? old("clientName") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->client->cnfagent : null) }}" spellcheck="false" required autocomplete="off">
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 px-1 d-none">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"> Client ID </span>
                        <input type="text" name="client_id" id="client_id" class="form-control" value="{{old("client_id") ? old("client_id") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->client_id : null) }}" readonly>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1">
                    <div class="input-group input-group-sm">
                        ...
                        <select name="payMode" id="payMode" class="form-control">
                            ...
                            <option value="cheque" {{old('payMode') &&  old('payMode')=='cheque' ? 'selected' : (!empty($mlomoneyreceipt) &&  $mlomoneyreceipt->payMode ==='cheque' ? 'selected' : null)}}> Cheque </option>
                            <option value="payorder" {{old('payMode') &&  old('payMode')=='payorder' ? 'selected' : (!empty($mlomoneyreceipt) &&  $mlomoneyreceipt->payMode ==='payorder' ? 'selected' : null)}}> Pay Order </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 px-1" id="pay_number_area">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="payNumber" name="payNumber" class="form-control" value="{{ old("payNumber") ? old("payNumber") : (!empty($mlomoneyreceipt) ? $mlomoneyreceipt->payNumber : null) }}">
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table id="moneyReceiptTable" class="table table-striped table-bordered table-sm">
                        ...
                        @foreach(old('particular') as $key => $oldParticular)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" style="text-align: right" name="amount[]" id="{{old('particular')[$key] == "Cleaning" ? 'cleaningAmount' : null}}" class="form-control form-control-sm amount" placeholder="0.00" value="{{old('amount')[$key]}}" onkeyup="totalOperation()" required>
                                </td>
                                <td>
                        ...
                        @foreach($mlomoneyreceipt->mloMoneyReceiptDetails as $receiptDetail)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input style="text-align: right" type="text" name="amount[]" id="{{$receiptDetail->particular == "Cleaning" ? 'cleaningAmount' : null}}" class="form-control form-control-sm amount" placeholder="0.00" value="{{$receiptDetail->amount}}" onkeyup="totalOperation()" required>
                                </td>
                                <td>
                                    <button class="btn btn-success btn-sm addItem" type="button"><i class="fa fa-plus"></i></button>
                                    <button class="btn btn-danger btn-sm deleteItem" type="button" tabindex="-1"><i class="fa fa-minus"></i></button>
                    ...
                    @else
                        <tr>
                            <td>
                                <select name="particular[]" class="form-control form-control-sm particular" tabindex="-1" required>
                                    @foreach($particulars as $particular)
                            ...
                            <td><input style="text-align: right" type="text" name="amount[]" class="form-control form-control-sm amount" value="3500" required onkeyup="totalOperation()"></td>
                            <td>
                                <button class="btn btn-success btn-sm addItem" type="button"><i class="fa fa-plus"></i></button>
                                <button class="btn btn-danger btn-sm deleteItem" type="button" tabindex="-1"><i class="fa fa-minus"></i></button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input style="text-align: right" type="text" name="amount[]" id="cleaningAmount" class="form-control form-control-sm amount" placeholder="0.00" required onkeyup="totalOperation()"></td>
                            <td>
                                <button class="btn btn-success btn-sm addItem" type="button"><i class="fa fa-plus"></i></button>
                                <button class="btn btn-danger btn-sm deleteItem" type="button" tabindex="-1"><i class="fa fa-minus"></i></button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input style="text-align: right" type="text" name="amount[]" class="form-control form-control-sm amount" placeholder="0.00" required onkeyup="totalOperation()"></td>
                            <td>
                                <button class="btn btn-success btn-sm addItem" type="button"><i class="fa fa-plus"></i></button>
                                <button class="btn btn-danger btn-sm deleteItem" type="button" tabindex="-1"><i class="fa fa-minus"></i></button>
                            </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            value="{{old('particular') ? $totalAmount : (!empty($mlomoneyreceipt) ? $totalAmount : null)}}" readonly> 
                        </td>
                        <td></td>
                    </tr>
                    </tfoot>
...
<script>
        ...
        .then(function (blno) {
            if(blno.fromDate){
                ...
                if(blno.extension){
                    ...
                    alert("Money Receipt has been generated before against this B/L No. Are you sure you want to extend?")
                }else{
                    $("#extension").empty();
                }
                ...
                for (var key in blno.typeCount) {
                    $("#containerList").append(`<button type="button" class="btn btn-primary btn-sm px-2" tabindex="-1">${key} <span class="badge badge-dark">${blno.typeCount[key]}</span></button>`);
                }
                ...
                if(blno.freeTime !== null){
                    $("#freeTime").val(blno.freeTime).addClass("readOnly").attr('readonly', true).attr("tabindex", -1);
                }else{
                ...
                $("#bolRef").focus();
                $("#vessel,#voyage,#description,#doNote,#rotationNo,#fromDate,#principal,#uptoDate,#freeTime,#duration,#freeTime,#chargeableDays, #cleaningAmount, #client_id, #clientName").val(null);
    ...
    $(document).ready(function () {
        payModeCheck();
        $('#issueDate').datepicker({format: "dd/mm/yyyy",autoclose: true,todayHighlight: true});
        $('#dated').datepicker({format: "dd/mm/yyyy",autoclose: true,todayHighlight: true});
        ...
        $("#uptoDate").on('blur change', function () {
            ...
            if(berthingStatus){
                ...
                .datepicker({format: "dd/mm/yyyy",autoclose: true,todayHighlight: true});//uptoDate
