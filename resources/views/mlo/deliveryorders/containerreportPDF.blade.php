                        ...
                        <tr>
                            ...
                            @if ($loop->first)
                                <td style="vertical-align: middle"
                                    rowspan="{{ count($mloblInformation->blcontainers) }}">
                                    {{ $mloblInformation->bolreference }} </td>
                                <td style="vertical-align: middle"
                                    rowspan="{{ count($mloblInformation->blcontainers) }}">
                                    {{ $mloblInformation->mlofeederInformation->feederVessel }} </td>
                                <td style="vertical-align: middle"
                                    rowspan="{{ count($mloblInformation->blcontainers) }}">
                                    {{ $mloblInformation->mlofeederInformation->voyageNumber }} </td>
                                <td style="vertical-align: middle"
                                    rowspan="{{ count($mloblInformation->blcontainers) }}">
                                    {{ $mloblInformation->mlofeederInformation->rotationNo }} </td>
                                <td style="vertical-align: middle"
                                    rowspan="{{ count($mloblInformation->blcontainers) }}">
                                    {{ $mloblInformation->principal->name }} </td>
                            @endif
                        </tr>
                    @endforeach
                @empty
