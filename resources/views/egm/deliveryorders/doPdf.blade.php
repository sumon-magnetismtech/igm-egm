    ...
    <div class="addressArea">
        ...
        <div class="pullRight">
            <div id="doInfo">
                ...
                <p> ISSUE DATE.
                    <strong>{{ date('d-M-Y', strtotime($moneyReceipt->deliveryOrder->issue_date)) }}</strong></p>
            </div>
        </div>
    </div> <!-- end contentArea -->
        ...
        <table>
            <tr>
                ...
                <td colspan="4"> <strong> BE DATE:</strong>
                    {{ $moneyReceipt->deliveryOrder->BE_Date ? date('d-M-Y', strtotime($moneyReceipt->deliveryOrder->BE_Date)) : null }}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="7"> Please delivery to <strong>{{ $moneyReceipt->client_name }}</strong> the under
                    mentioned goods.</td>
            </tr>
            <tr>
                <td colspan="3"> <strong> V. Name: </strong>{{ $moneyReceipt->houseBl->masterbl->fvessel }}
                    V.{{ $moneyReceipt->houseBl->masterbl->voyage }}</td>
                <td colspan="2"> <strong> Arrival DT: </strong>
                    {{ $moneyReceipt->houseBl->masterbl->arrival ? date('d-M-Y', strtotime($moneyReceipt->houseBl->masterbl->arrival)) : null }}
                </td>
            ...
            <tr>
                <td colspan="7"> VALID UP TO :<strong>
                        {{ $moneyReceipt->deliveryOrder->upto_date ? date('d-M-Y', strtotime($moneyReceipt->deliveryOrder->upto_date)) : null }}</strong>
                </td>
            </tr>
            <tr>
