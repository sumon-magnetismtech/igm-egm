...
<head>
    ...
    <style>
        ...
        table, table th, table td {border-spacing: 0; font-size: 10px; border-collapse: collapse}
    ...
    <div id="tableArea overFlow">
        <table width="100%">
            ...
            <tr>
                ...
                <td>{{$mloblinformation->mlofeederInformation->feederVessel}} V. {{$mloblinformation->mlofeederInformation->voyageNumber}}</td>
                <td>{{$mloblinformation->mlofeederInformation->berthingDate ? date('d/m/Y', strtotime($mloblinformation->mlofeederInformation->berthingDate)) : "--"}}</td>
