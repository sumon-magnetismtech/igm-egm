...
@foreach($blInformations as $blInformation)
    ...
    <div class="addressArea">
        ...
        <div class="mrTB">
            <p>Dear Sir(s), </p>
            <p >We are pleased to inform you that above feeder vessel is scheduled to arrive at <strong>{{$blInformation->PUloding}}</strong>
                on or about
                <b>
    ...
    <div id="tableArea overFlow">
        <table width="100%" border="none">
            ...
            <tr>
                ...
                <td>:</td>
                <th>{{strtoupper($blInformation->mlofeederInformation->feederVessel)}} V.{{$blInformation->mlofeederInformation->voyageNumber}}</th>
            </tr>
            <tr>
                <td>IMP. ROT. NO. </td>
                <td>:</td>
...
@if($blInformations->isNotEmpty())
    <div id="ArrivalSummary">
        ...
        <div>
            <p style="float: left"> <strong> F/VSL & Voyage  </strong> : {{$blInformations->first()->mlofeederInformation->feederVessel}} V.{{$blInformations->first()->mlofeederInformation->voyageNumber}} </p>
        </div>
