...
<body>
    ...
    <p class="mrTB"> বিষয়: জাহাজ এমভি <span class="EngFont"> {{$permissionData->feederVessel}}</span> আমদানী পালা নং: <span class="EngFont">{{$permissionData->rotationNo}}</span>
        ...
        @endforeach
         ...
         এফসিএল কন্টেইনার নং সংযুক্ত তালিকা মতে বন্দরের কন্টেইনার পানগাঁও   ইয়ার্ড থেকে জাহাজ যোগে পানগাঁও   আইসিটিতে  প্রেরণ প্রসঙ্গে।
    </p><br>
    <p class="mrTB">
    ...
    <div class="contentArea overFlow" style="text-align: justify">
        <p class="mrTB">
            উপরোক্ত বিষয়ে জাহাজ প্রতিনিধির সূত্রোক্ত আবেদন এর প্রেক্ষিতে বর্ণিত জাহাজ যোগে আনীত <strong>
                @foreach($types as $type=>$key)
                    <span class="EngFont">  {{$key}} X {{$type}}</span> (লোড),
                @endforeach
                = <span class="EngFont">{{count($blcontainers)}}</span>
                    টি (এফসিএল/) </strong> পানগাঁও    বাউন্ড কন্টেইনারের জন্য কাস্টমস কর্তৃক গৃহীত পানগাঁও    মেনিফেস্ট এর ভিত্তিতে সংযুক্ত তালিকা অনুযায়ী এবং পরবর্তী অত্র দপ্তর থেকে প্রদত্ত এসাইনমেন্ট মোতাবেক কন্টেইনার গুলি বন্দরের পানগাঁও   ইয়ার্ড থেকে জাহাজযোগে পানগাঁও আইসিটিতে প্রেরণের জন্য বলা গেল।
        </p><br><br>
        ...
        <p>৩) পরিবহন পরিদর্শক ইয়ার্ড/সি,সি,টি/আইসিডি/ চ ব ক এর অবগতি এবং কন্টেইনারগুলো পানগাঁও    আইসিটিতে প্রেরণের পর ১টি তালিকা টিআই কন্টেইনার বিলিং শাখা বরাবরে প্রেরণ করতে বলা গেল। কন্টেইনারগুলো বাস্তবে ওভার ওয়েট/ওভার হাইট পাওয়া গেলে তাও জানাতে বলা গেল।</p>
        ...
        <p>ইনচার্জ (গুডস-৫) টাওয়ার ভবন / চ ব ক এর অবগতি ও কন্টেইনার /গুলি পরিবহন বাবদ রেলওয়ের ফ্রেইট শিপিং এজেন্টের আর, ডি একাউন্ট নং-৬৩৯৫১০০৫ থেকে আদায় সহ কন্টেইনারটি /গুলো পানগাঁও    আইসিটিতে প্রেরণের জন্য বুক করার নিমিত্তে এতদসংগে আইজিএম এবং কন্টেইনারের তালিকা প্রেরণ করা গেল।  </p><br><br>
