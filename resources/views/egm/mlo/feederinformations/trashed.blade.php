    ...
    <form action="" method="get">
        <div class="row">
            <div class="col-md-3 pr-md-1 my-1 my-md-0">
                <input type="text" id="feederVessel" name="feederVessel" class="form-control form-control-sm text-uppercase"
                    placeholder="Vessel" autocomplete="off">
            </div>
            <div class="col-md-2 px-md-1 my-1 my-md-0">
                <input type="text" id="voyageNumber" name="voyageNumber"
                    class="form-control form-control-sm text-uppercase" list="voyageList" placeholder="Voyage No"
                    autocomplete="off">
            ...
            <tbody>
                @forelse($feederInformations as $key => $feederInfo)
                    <tr>
                        ...
                        <td class="text-left"> {{ $feederInfo->depPortName }}
                            {{ !empty($feederInfo->depPortCode) ? "($feederInfo->depPortCode)" : null }}</td>
                        <td class="text-left"> {{ $feederInfo->desPortName }}
                            {{ !empty($feederInfo->desPortCode) ? "($feederInfo->desPortCode)" : null }}</td>
