...
@section('breadcrumb-button')
    <a href="{{ url('egmfeederinformations') }}" class="btn btn-out-dashed btn-sm btn-warning"><i
    ...
    <div class="row px-2">
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 px-1">
            <div class="input-group input-group-sm ">
                ...
                <input type="text" id="careerName" class="form-control" value="Magnetism Tech Ltd Limited"
                    placeholder="Magnetism Tech Ltd Limited" readonly tabindex="-1">
