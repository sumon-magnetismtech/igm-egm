        ...
        <table id="example" class="table table-striped table-bordered">
            ...
            @forelse($masterbls as $key => $masterbl)
                <tr>
                    ...
                    <td><a class="link" data-toggle="tooltip" title="Click for IGM-{{$masterbl->id}} Details" target="_blank" href="{{url('egmmasterbls/'.$masterbl->id)}}">{{$masterbl->id}}</a></td>
                    <td>
                        @if($masterbl->noc)
                    ...
                    <td>
                        <div class="icon-btn">
                            <nobr>
                                <a href="{{url('egmmasterbls/'.$masterbl->id)}}" data-toggle="tooltip" title="Details" class="btn btn-primary"><i class="fas fa-eye"></i></a>

                                @can('egmmasterbl-edit')
                                <a href="{{ url('egmmasterbls/'.$masterbl->id.'/edit') }}" data-toggle="tooltip" title="Edit" class="btn btn-warning"><i class="fas fa-pen"></i></a>
                                @endcan

                                @can('egmmasterbl-delete')
                                <form action="{{ url('egmmasterbls', [$masterbl->id]) }}" method="POST" data-toggle="tooltip" title="Delete" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ url('egmmasterbls/unstaffingSheet/'.$masterbl->id) }}" data-toggle="tooltip" title="Unstaffing Sheet" class="btn btn-secondary"><i class="fas fa-box-open"></i></a>
