    ...
    @else
        ...
        <div class="row d-flex align-items-end">
            <div class="col-xl-1 col-lg-2 col-md-2">
                <div class="border-checkbox-section">
                    <div class="border-checkbox-group border-checkbox-group-primary">
                        <input type="checkbox" id="noc" name="noc" class="border-checkbox" @if(old('noc') || !empty($egmmasterbl) && $egmmasterbl->noc) checked @endif>
                ...
                <div class="input-group input-group-sm ">
                    ...
                    <select name="blnaturecode" id="blnaturecode" class="form-control" tabindex="-1" data-parsley-required="true" onchange="getblnaturetype()">
                        @foreach($blnaturecodes as $blnaturecode)
                            <option value="{{$blnaturecode}}" {{(!empty($egmmasterbl)) && $egmmasterbl->blnaturecode == $blnaturecode ? 'selected' : null}}> {{$blnaturecode}} </option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-xl-2 col-lg-8 col-md-8 ">
                <div class="input-group input-group-sm ">
                    <input type="text" id="blnaturetype" name="blnaturetype" class="form-control" tabindex="-1" value="{{ old("blnaturetype") ? old("blnaturetype") : (!empty($egmmasterbl) ? $egmmasterbl->blnaturetype : null) }}" placeholder="BOL Nature">
                </div>
            </div>
                ...
                <div class="input-group input-group-sm ">
                    ...
                    <select id="bltypecode" name="bltypecode" class="form-control" tabindex="-1" data-parsley-required="true" onchange="getbltypename()">
                        @foreach($bltypecodes as $bltypecode)
                            <option value="{{$bltypecode}}" {{!empty($egmmasterbl) && $egmmasterbl->bltypecode == $bltypecode ? 'selected' : null}}> {{$bltypecode}} </option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-xl-4 col-lg-8 col-md-8 ">
                <div class="input-group input-group-sm ">
                    <input type="text" id="bltypename" name="bltypename" class="form-control" tabindex="-1" value="{{ old("bltypename") ? old("bltypename") : (!empty($egmmasterbl) ? $egmmasterbl->bltypename : null) }}" placeholder="Enter B/L Type">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Depot <span class="text-danger">*</span></span>
                    <input type="text" id="depot" name="depot" class="form-control" tabindex="-1" value="{{ old("depot") ? old("depot") : (!empty($egmmasterbl) ? $egmmasterbl->depot : "CHITTAGONG PORT") }}" placeholder="Enter Depot Name">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
        ...
        <div class="row d-flex align-items-end">
            <div class="col-xl-4 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" name="mblno" class="form-control text-uppercase" autofocus value="{{ old("mblno") ? old("mblno") : (!empty($egmmasterbl) ? $egmmasterbl->mblno : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Feeder Vessel <span class="text-danger">*</span></span>
                    <input type="text" id="fvessel" name="fvessel" class="form-control text-uppercase" value="{{ old("fvessel") ? old("fvessel") : (!empty($egmmasterbl) ? $egmmasterbl->fvessel : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Voyage No <span class="text-danger">*</span></span>
                    <input type="text" id="voyage" name="voyage" class="form-control text-uppercase" value="{{ old("voyage") ? old("voyage") : (!empty($egmmasterbl) ? $egmmasterbl->voyage : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Departure <span class="text-danger">*</span></span>
                    <input type="text" id="departure" name="departure" class="form-control" value="{{ old("departure") ? old("departure") : (!empty($egmmasterbl) ? $egmmasterbl->departure ? $egmmasterbl->departure->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Arrival <span class="text-danger">*</span></span>
                    <input type="text" id="arrival" name="arrival" class="form-control" value="{{ old("arrival") ? old("arrival") : (!empty($egmmasterbl) ? $egmmasterbl->arrival ? $egmmasterbl->arrival->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Berthing </span>
                    <input type="text" id="berthing" name="berthing" class="form-control" value="{{ old("berthing") ? old("berthing") : (!empty($egmmasterbl) ? $egmmasterbl->berthing ? $egmmasterbl->berthing->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" autocomplete="off" >
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Rotation </span>
                    <input type="text" id="rotno" name="rotno" class="form-control" value="{{ old("rotno") ? old("rotno") : (!empty($egmmasterbl) ? $egmmasterbl->rotno : null) }}">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="pocode" name="pocode" class="form-control" value="{{ old("pocode") ? old("pocode") : (!empty($egmmasterbl) ? $egmmasterbl->pocode : null) }}" onchange="loadPortName()" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="poname" name="poname" class="form-control" value="{{ old("poname") ? old("poname") : (!empty($egmmasterbl) ? $egmmasterbl->poname : null) }}" required tabindex="-1">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="pucode" name="pucode" class="form-control" value="{{ old("pucode") ? old("pucode") : (!empty($egmmasterbl) ? $egmmasterbl->pucode : "BDCGP") }}" onchange="loadPortName2()">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="puname" name="puname" class="form-control" value="{{ old("puname") ? old("puname") : (!empty($egmmasterbl) ? $egmmasterbl->puname : null) }}" required tabindex="-1">
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" list="principals" id="principal" class="form-control" name="principal" value="{{ old("principal") ? old("principal") : (!empty($egmmasterbl) ? $egmmasterbl->principal : null) }}" required>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mv" name="mv" class="form-control text-uppercase" value="{{ old("mv") ? old("mv") : (!empty($egmmasterbl) ? $egmmasterbl->mv : null) }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mlocode" name="mlocode" class="form-control" list="mlocodes" value="{{ old("mlocode") ? old("mlocode") : (!empty($egmmasterbl) ? $egmmasterbl->mlocode : null) }}" onchange="loadMloName()" autocomplete="off">
            ...
            <div class="col-xl-8 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mloname" name="mloname" class="form-control" value="{{ old("mloname") ? old("mloname") : (!empty($egmmasterbl) ? $egmmasterbl->mloname : null) }}" autocomplete="off">
                </div>
            </div>
