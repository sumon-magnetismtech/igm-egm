    ...
    <div id="tableArea overFlow">
        <p>
            ...
            Undertaking and guarantee for the below consignment of
                ...
                @endforeach
            FCL shipments under MCC B/L No. {{$housebl->masterbl->mblno}} against the vessel {{$housebl->masterbl->fvessel}} V.{{$housebl->masterbl->voyage}}, Imp. Rot. No.  {{$housebl->masterbl->rotno}} to be taken to
        ...
        <br>
        <p>
            We do hereby write to confirm you that we shall be liable to satisfy and fulfill the guarantee obligations by the consignee in
        ...
        <p>
            ...
            Yours faithfully,
            <br>
            For QC Logistics Limited.<br><br><br><br>
            (Mohammad Yeakub)
        </p>
        <br>
        <br>
