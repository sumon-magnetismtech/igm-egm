...
<div class="addressArea">
    ...
    <div class="mrTB">
        <p>Dear Sir(s), </p>
        <p >We are pleased to inform you that above feeder vessel is scheduled to arrive at <strong>Chittagong</strong>
            on or about 
            <strong> {{($hblInfo->masterbl->arrival) ? date('d-m-Y', strtotime($hblInfo->masterbl->arrival)) : '--'}} </strong>
            with the under noted cargo on your account. </p>
    </div>
</div> <!-- end contentArea -->
