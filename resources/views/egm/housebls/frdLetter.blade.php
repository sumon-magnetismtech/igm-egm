...
@endif
    ...
    <div id="contentArea overFlow" style="text-align: justify">
        ...
        <ol>
            <li> Name of the Detention Payer mentioned above is the rightful party as per duly endorsed House Bill of Lading and Customs Bill of Entry. </li>
            <li> In case of any financial transaction for this bill of lading, we have no objection if {{$masterBl->mloname}} settles either with us or the detention payer only (provided Detention Payer is not the freight forwarder itself).</li>
