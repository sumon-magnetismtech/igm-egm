...
<header>
        <h6 class="float-left pl-5" id="companyName"> QC Logistics Limited </h6>
</header>
<footer>
    <p>
        ...
        @foreach($housebls as $key => $housebl)
            ...
            @foreach($housebl->containers as $container)
                <tr>
                    ...
                    <td style="vertical-align: middle"> {{$housebl->masterbl->arrival ? date('d/m/y', strtotime($housebl->masterbl->arrival)) : null}} </td>
                    <td style="vertical-align: middle"> {{$housebl->masterbl->berthing ? date('d/m/y', strtotime($housebl->masterbl->berthing)) : null}} </td>
                    ...
                    <td style="vertical-align: middle">{{($housebl->moneyReceipt && $housebl->moneyReceipt->deliveryOrder) ? $housebl->moneyReceipt->deliveryOrder->id : "--"}}</td>
                    <td style="vertical-align: middle">{{($housebl->moneyReceipt && $housebl->moneyReceipt->deliveryOrder) ? date('d-m-y', strtotime($housebl->moneyReceipt->deliveryOrder->issue_date)) : "--"}}</td>
                    ...
                    <td style="vertical-align: middle">{{$housebl->moneyReceipt ? $housebl->moneyReceipt->client_name ."; " .$housebl->moneyReceipt->client_mobile : "--"}}</td>
                </tr>
            @endforeach
