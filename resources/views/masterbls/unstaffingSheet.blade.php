...
<head>
    ...
    <style>
        ...
        #containerInfoTable, #containerInfoTable td{
            border: none;
            font-size: 12px;
    ...
    <div class="containerInfo">
        <table width="100%" id="containerInfoTable">
            ...
            <tr>
                ...
                <td> ARRIVAL DATE : <strong>{{$masterbl->arrival ? date('d-m-Y', strtotime($masterbl->arrival)) : null}}</strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td> BIRTHING: <strong>{{$masterbl->berthing ? date('d-m-Y', strtotime($masterbl->berthing)) : null}}</strong> / <strong>{{$masterbl->jetty}}</strong></td>
