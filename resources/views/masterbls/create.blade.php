...
@section('content')
    ...
    @if($formType == 'edit')
        <form action="{{ route('masterbls.update', $masterbl->id) }}" method="post" class="custom-form">
        @method('PUT')
        <input type="hidden"  name="id" value="{{$masterbl->id}}">
    @else
        <form action="{{ route('masterbls.store') }}" method="post" class="custom-form">
        @endif
        @csrf
        <div class="row d-flex align-items-end">
            <div class="col-xl-1 col-lg-2 col-md-2">
                <div class="border-checkbox-section">
                    <div class="border-checkbox-group border-checkbox-group-primary">
                        <input type="checkbox" id="noc" name="noc" class="border-checkbox" @if(old('noc') || !empty($masterbl) && $masterbl->noc) checked @endif>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="cofficename" name="cofficename" class="form-control" value="Custom House, Chittagong" readonly>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-4 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> BOL Nature <span class="text-danger">*</span></span>
                    <select name="blnaturecode" id="blnaturecode" class="form-control" tabindex="-1" data-parsley-required="true" onchange="getblnaturetype()">
                        @foreach($blnaturecodes as $blnaturecode)
                            <option value="{{$blnaturecode}}" {{(!empty($masterbl)) && $masterbl->blnaturecode == $blnaturecode ? 'selected' : null}}> {{$blnaturecode}} </option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-xl-2 col-lg-8 col-md-8 ">
                <div class="input-group input-group-sm ">
                    <input type="text" id="blnaturetype" name="blnaturetype" class="form-control" tabindex="-1" value="{{ old("blnaturetype") ? old("blnaturetype") : (!empty($masterbl) ? $masterbl->blnaturetype : null) }}" placeholder="BOL Nature">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-4 ">
                <div class="input-group input-group-sm ">
                    ...
                    <select id="bltypecode" name="bltypecode" class="form-control" tabindex="-1" data-parsley-required="true" onchange="getbltypename()">
                        @foreach($bltypecodes as $bltypecode)
                            <option value="{{$bltypecode}}" {{!empty($masterbl) && $masterbl->bltypecode == $bltypecode ? 'selected' : null}}> {{$bltypecode}} </option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-xl-4 col-lg-8 col-md-8 ">
                <div class="input-group input-group-sm ">
                    <input type="text" id="bltypename" name="bltypename" class="form-control" tabindex="-1" value="{{ old("bltypename") ? old("bltypename") : (!empty($masterbl) ? $masterbl->bltypename : null) }}" placeholder="Enter B/L Type">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Depot <span class="text-danger">*</span></span>
                    <input type="text" id="depot" name="depot" class="form-control" tabindex="-1" value="{{ old("depot") ? old("depot") : (!empty($masterbl) ? $masterbl->depot : "CHITTAGONG PORT") }}" placeholder="Enter Depot Name">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
                <span class="input-group-addon"> Carrier Name <span class="text-danger">*</span></span>
                    <input type="text" id="carrier" name="carrier" class="form-control" value="QC Logistics Limited" placeholder="QC Logistics Limited" disabled>
            ...
            <div class="col-xl-7 col-lg-12 col-md-12">
                <div class="input-group input-group-sm ">
                    ...
                    <textarea class="form-control" rows="1" aria-label="Carrier Address" tabindex="-1" name="carrieraddress" id="carrieraddress" readonly>CANDF TOWER, 4TH FLOOR, AGRABAD, CHITTAGONG, BANGLADESH</textarea>
                </div>
            </div>
        </div><!-- end row -->
        ...
        <div class="row d-flex align-items-end">
            <div class="col-xl-4 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" name="mblno" class="form-control text-uppercase" autofocus value="{{ old("mblno") ? old("mblno") : (!empty($masterbl) ? $masterbl->mblno : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-5 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Feeder Vessel <span class="text-danger">*</span></span>
                    <input type="text" id="fvessel" name="fvessel" class="form-control text-uppercase" value="{{ old("fvessel") ? old("fvessel") : (!empty($masterbl) ? $masterbl->fvessel : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Voyage No <span class="text-danger">*</span></span>
                    <input type="text" id="voyage" name="voyage" class="form-control text-uppercase" value="{{ old("voyage") ? old("voyage") : (!empty($masterbl) ? $masterbl->voyage : null) }}" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Departure <span class="text-danger">*</span></span>
                    <input type="text" id="departure" name="departure" class="form-control" value="{{ old("departure") ? old("departure") : (!empty($masterbl) ? $masterbl->departure ? $masterbl->departure->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Arrival <span class="text-danger">*</span></span>
                    <input type="text" id="arrival" name="arrival" class="form-control" value="{{ old("arrival") ? old("arrival") : (!empty($masterbl) ? $masterbl->arrival ? $masterbl->arrival->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" required autocomplete="off">
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Berthing </span>
                    <input type="text" id="berthing" name="berthing" class="form-control" value="{{ old("berthing") ? old("berthing") : (!empty($masterbl) ? $masterbl->berthing ? $masterbl->berthing->format('d/m/Y') : null : null) }}" placeholder="dd/mm/yyyy" autocomplete="off" >
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    <span class="input-group-addon"> Rotation </span>
                    <input type="text" id="rotno" name="rotno" class="form-control" value="{{ old("rotno") ? old("rotno") : (!empty($masterbl) ? $masterbl->rotno : null) }}">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="pocode" name="pocode" class="form-control" value="{{ old("pocode") ? old("pocode") : (!empty($masterbl) ? $masterbl->pocode : null) }}" onchange="loadPortName()" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="poname" name="poname" class="form-control" value="{{ old("poname") ? old("poname") : (!empty($masterbl) ? $masterbl->poname : null) }}" required tabindex="-1">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="pucode" name="pucode" class="form-control" value="{{ old("pucode") ? old("pucode") : (!empty($masterbl) ? $masterbl->pucode : "BDCGP") }}" onchange="loadPortName2()">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="puname" name="puname" class="form-control" value="{{ old("puname") ? old("puname") : (!empty($masterbl) ? $masterbl->puname : null) }}" required tabindex="-1">
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" list="principals" id="principal" class="form-control" name="principal" value="{{ old("principal") ? old("principal") : (!empty($masterbl) ? $masterbl->principal : null) }}" required>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mv" name="mv" class="form-control text-uppercase" value="{{ old("mv") ? old("mv") : (!empty($masterbl) ? $masterbl->mv : null) }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mlocode" name="mlocode" class="form-control" list="mlocodes" value="{{ old("mlocode") ? old("mlocode") : (!empty($masterbl) ? $masterbl->mlocode : null) }}" onchange="loadMloName()" autocomplete="off">
            ...
            <div class="col-xl-8 col-lg-6 col-md-6">
                <div class="input-group input-group-sm ">
                    ...
                    <input type="text" id="mloname" name="mloname" class="form-control" value="{{ old("mloname") ? old("mloname") : (!empty($masterbl) ? $masterbl->mloname : null) }}" autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-xl-12 col-lg-6 col-md-6 ">
                <div class="input-group input-group-sm ">
                    ...
                    <textarea id="mloaddress" name="mloaddress" class="form-control" rows="2">{{ old("mloaddress") ? old("mloaddress") : (!empty($masterbl) ? $masterbl->mloaddress : null) }}</textarea>
                </div>
            </div>
        </div> <!-- end row -->
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#igm").on('blur', function(){
                ...
                let url ='{{url("cloneMasterblById/")}}/'+igm;
                fetch(url)
                        .then((resp) => resp.json())
