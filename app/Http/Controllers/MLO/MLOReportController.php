...
class MLOReportController extends Controller
{
    ...
    {
        $feederinformation = Feederinformation::with('mloblinformation.blcontainers', 'mloblinformation.blNotify', 'mloblinformation.package')
    ...
    {
        $blinformationGroups = Mloblinformation::whereHas('mlofeederInformation', function ($q) use ($feeder_id) {
            $q->where('id', $feeder_id);
        })->where(function ($q) {
