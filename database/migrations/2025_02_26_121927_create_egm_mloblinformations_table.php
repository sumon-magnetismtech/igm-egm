...
class CreateEgmMloblinformationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('egm_mloblinformations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('egm_mloblinformations');
    }
}
